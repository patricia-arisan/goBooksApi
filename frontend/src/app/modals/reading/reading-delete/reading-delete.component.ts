...
@Component({
  ...
  templateUrl: './reading-delete.component.html',
  styleUrl: './reading-delete.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReadingDeleteComponent implements OnInit{
  user!: Usuario;
  estados!: Estado[];
  lectura!: Lectura;
  libro!: Libro;
